...
print ("Exammple: Lado STEP file, generated by a CAD")
#import numpy as np
...
tshape_mesh.SetFilename(chrono.GetChronoDataPath() + shapePath)
tshape.AddAsset(shape_mesh)
tmc = chrono.ChTriangleMeshConnected()
tmc.LoadWavefrontMesh(chrono.GetChronoDataPath() + shapePath)
#
